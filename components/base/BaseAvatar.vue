...
const { src, fallbackSrc, label, increasedSpacing = false } = defineProps<{
  src?: string | string[]
  ...
  <div class="relative flex items-center">
    ...
    >
      <div
        ...
        class="w-24 h-24 flex items-center justify-center overflow-hidden rounded-full bg-center bg-cover flex-shrink-0 [&.icon--16]:!w-16 [&.icon--16]:!h-16 [&.icon--18]:!w-18 [&.icon--18]:!h-18 [&.icon--20]:!w-20 [&.icon--20]:!h-20 [&.icon--20]:text-[8px] [&.icon--24]:!w-24 [&.icon--24]:!h-24 [&.icon--32]:!w-32 [&.icon--32]:!h-32 [&.icon--36]:!w-36 [&.icon--36]:!h-36 [&.icon--38]:!w-38 [&.icon--38]:!h-38 [&.icon--40]:!w-40 [&.icon--40]:!h-40 [&.icon--46]:!w-46 [&.icon--46]:!h-46 [&.icon--46]:text-[16px]"
        :class="[
          increasedSpacing
            ? '[&:not(:first-child)]:-ml-1 [&.icon--38:not(:first-child)]:-ml-9 [&.icon--40:not(:first-child)]:-ml-11 [&.icon--46:not(:first-child)]:-ml-5'
            : '[&:not(:first-child)]:-ml-5 [&.icon--38:not(:first-child)]:-ml-14 [&.icon--40:not(:first-child)]:-ml-16 [&.icon--46:not(:first-child)]:-ml-12',
        ]"
        v-bind="$attrs"
