...
const projectId = import.meta.env.VITE_REOWN_PROJECT_ID || "b4d5f74af3e208693c5c26a4eb041592" // https://reown.com/
const url =
  import.meta.env.VITE_APP_URL ||
  (typeof window !== "undefined"
    ? window.location.origin
    : "https://euler-securitize-production.up.railway.app")
