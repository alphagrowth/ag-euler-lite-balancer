...
<template>
  <section class="w-full h-dvh -mt-16 -mb-[98px]">
    <div
      class="relative flex flex-col items-center justify-between gap-24 h-full pb-64 mobile:-mx-16"
    >
